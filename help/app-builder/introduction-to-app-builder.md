...
description: Scopri Adobe Developer App Builder e come l’estensibilità out-of-process consente di creare estensioni Commerce sicure e scalabili senza problemi di compatibilità in-process.
jira: KT-11433
doc-type: Tutorial
duration: 300
...
>[!VIDEO](https://video.tv.adobe.com/v/3432197?captions=ita&learn=on)
...
* estensibilità dell’esperienza utente: per supportare i requisiti aziendali o creare proprietà digitali, vetrine e applicazioni di back-office specifiche per il cliente, estendere l’esperienza di base.
...
## Perché saperne di più su App Builder

Poiché Adobe Commerce non è un prodotto completamente SAAS, il codice sviluppato può aggiungere complessità e considerazioni sull’aggiornamento. Utilizzando l’estensibilità out-of-process, come App Builder, puoi fornire funzionalità personalizzate e univoche all’archivio Adobe Commerce senza richiedere metodi in-process.
...
* Lo spostamento di funzioni e logica all’esterno di Commerce consente di liberare risorse normalmente utilizzate dai metodi di sviluppo in-process.
...
* servizi come I/O Runtime per l&#39;hosting dell&#39;infrastruttura sulla piattaforma senza server di Adobe ed Eventi di I/O per le integrazioni basate su eventi. Adobe fornisce inoltre supporto preconfigurato per l’archiviazione di dati e file.
...
Per ulteriori dettagli sull&#39;architettura di App Builder, vedere [Panoramica dell&#39;architettura](https://developer.adobe.com/app-builder/docs/guides/app_builder_guides/architecture_overview/architecture-overview){target="_blank"}.
...
* [Guida introduttiva di App Builder](https://developer.adobe.com/app-builder/docs/get_started/app_builder_get_started/first-app){target="_blank"}
...
* [Documentazione di App Builder](https://developer.adobe.com/app-builder/docs/intro_and_overview){target="_blank"}
