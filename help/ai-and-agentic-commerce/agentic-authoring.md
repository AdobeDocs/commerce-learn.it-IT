---
title: Authoring agente
description: Scopri in che modo Experience Workspace utilizza un assistente AI per la creazione di pagine di vetrina con marchio a partire da prompt in linguaggio naturale collegati al catalogo live.
role: User
level: Beginner
...
* Addetti marketing
* Autori di contenuti
* Sviluppatori storefront

## Contenuto video

* Superficie di authoring unificata con struttura dei file, contenuto della pagina e anteprima live affiancate
* Assistente all’authoring di IA connesso al catalogo dei prodotti tramite MCP
* Libreria Prompt e Skills Builder per estendere le funzionalità di assistente
