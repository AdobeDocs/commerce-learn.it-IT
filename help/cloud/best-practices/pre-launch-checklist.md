...
2. [!BADGE Blocco]{type=caution tooltip="Potenziale bloccante"}[Guida utente](https://experienceleague.adobe.com/it/docs/commerce-operations/tools/site-wide-analysis-tool/intro){target="_blank"})
...
5. Conferma distribuzione del codice e test negli ambienti di staging e produzione ([Ulteriori informazioni](https://experienceleague.adobe.com/it/docs/commerce-cloud-service/user-guide/develop/test/staging-and-production){target="_blank"}).
...
2. [!BADGE Blocco]{type=caution tooltip="Potenziale bloccante"}[questo articolo](https://experienceleague.adobe.com/it/docs/commerce-knowledge-base/kb/how-to/ssl-tls-certificates-for-magento-commerce-cloud-faq){target="_blank"} per ulteriori informazioni.
...
4. Abilita Sendgrid SPF e DKIM
   ...
   >[!NOTE]
   > Aggiungere i record CNAME SendGrid per ogni dominio alla configurazione DNS. Leggi [Servizio e-mail SendGrid](https://experienceleague.adobe.com/it/docs/commerce-cloud-service/user-guide/project/sendgrid){target="_blank"} per scoprire come modificare i domini del mittente e altro ancora.
...
5. Rimuovere gli utenti che non fanno più parte del progetto (vedere [Creare e gestire gli utenti](https://experienceleague.adobe.com/it/docs/commerce-cloud-service/user-guide/project/user-access){target="_blank"}).
6. Le password per gli amministratori sono configurate (vedi [Requisiti password amministratore](https://experienceleague.adobe.com/it/docs/commerce-admin/systems/security/security-admin){target="_blank"}).
