...
+ Guida introduttiva {#getting-started}
   ...
   + [!DNL Commerce] per sviluppatori {#development}
      ...
      + [4 - Base di codice](../backend-development/backend-4-code-base.md)
   ...
   + [!DNL Commerce] per utenti aziendali {#merchants}
      ...
      + [1.3 - Ambiti, siti e store](../site-management/introduction/1-3-apps-scopes-sites-stores.md)
      + [1.4 - Viste e cache dello store](../site-management/introduction/1-4-store-views-cache.md)
      + [1.5 - Account utente e ruoli amministratore](../site-management/introduction/1-5-users-roles.md)
      ...
      + [2.2 - Pagine di destinazione per categoria](../site-management/introduction/2-2-category-landing-page.md)
      + [3.1 - Tipi di prodotto e opzioni](../site-management/introduction/3-1-product-types-options.md)
      ...
      + [3.4 - Set di attributi del prodotto](../site-management/introduction/3-4-product-attribute-sets.md)
      ...
      + [3.7 - Importazione/Esportazione di prodotti](../site-management/introduction/3-7-import-export-products.md)
      + [3.8 - Buoni regalo](../site-management/introduction/3-8-gift-cards.md)
      + [4.1 - Navigazione su più livelli](../site-management/introduction/4-1-layered-navigation.md)
      + [4.2 - Organizzare Categorie Di Prodotti](../site-management/introduction/4-2-arrange-product-categories.md)
      + [5.1 - Esperienza vetrina](../site-management/introduction/5-1-storefront-experience.md)
...
+ Gestione catalogo {#catalog}
   + [Catalog Service per Adobe Commerce](../site-management/catalog-service.md)
...
+ MBI {#mbi}
   ...
   + Webinar registrati {#webinars}
      ...
      + [Ottimizzazione della Data Warehouse di MBI](https://experienceleague.adobe.com/docs/commerce-events/events/mbi/2021/optimize-data-warehouse.html)
      + [Approfondimento dashboard di MBI](https://experienceleague.adobe.com/docs/commerce-events/events/mbi/2021/dashboards-deep-dive.html)
      + [Preparazione alle festività con MBI](https://experienceleague.adobe.com/docs/commerce-events/events/mbi/2021/holiday-readiness.html)
   ...
   + Introduzione alla serie video MBI {#introduction}
      ...
      + [Sintesi](../business-intelligence/6-executive-summary-dashboard.md)
      + [Dashboard ordini](../business-intelligence/7-orders-dashboard.md)
      + [Dashboard incentrate sul cliente](../business-intelligence/8-customer-focused-dashboards.md)
      + [Analisi per categoria](../business-intelligence/9-category-analysis.md)
      + [Tracciamento del ritorno sull’investimento](../business-intelligence/10-roi-tracking.md)
